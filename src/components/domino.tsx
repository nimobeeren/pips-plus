...
export function Domino({
  ...
  if (noRotation) {
    ...
    return (
      <div
        className={cn(
          "flex cursor-grab touch-none select-none items-stretch border-2 border-neutral-300 bg-white shadow-sm outline-none focus-visible:ring-3 focus-visible:ring-blue-400 focus-visible:ring-offset-2 rounded-lg",
